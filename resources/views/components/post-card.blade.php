@props(['post'])
    ...
    <div class="col-lg-6 col-md-6 " style="margin-top: -40px;">
        <div class="single-post">
            ...
            <p>{!! Str::limit("$post->description", 40, ' ...') !!} <a href="/posts/{{$post->id}}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="orange" class="bi bi-arrow-right" viewBox="0 0 16 16">
